...
- Fuzzy LIKE Filtering: Always filter descriptive text columns (categories, products, colors, names) using `LIKE '%<term>%'` (or break compound words like `LIKE '%CHANG%PACK%'`) rather than strict `=` to accommodate spelling variations (e.g. 'CHANGABLE' vs 'CHANGEABLE', 'Trans' vs 'TRANS').
