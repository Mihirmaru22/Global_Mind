...
- Lead vs Customer Disambiguation: When a name or inquiry is asked for, check if it's a CRM lead (lead table: contact_name OR company_name) or an established party (party table: party_name OR contact_person1). If 'lead' or 'inquiry' is mentioned, query lead table. If 'customer' or 'vendor' or 'party' is mentioned, query party table.
