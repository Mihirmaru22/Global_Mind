...
- Lead Name & Contact Search: A lead or inquiry name can be a contact person (lead.contact_name) OR a company (lead.company_name). When filtering for a lead by name, ALWAYS search both: WHERE (lead.contact_name LIKE '%<name>%' OR lead.company_name LIKE '%<name>%') AND lead.deleted_at IS NULL.
